...
3. Implement features that allow library to work not only with file paths, but streams etc. for reading and writing data on the user side (though in the end, writing is already performed to a stream now).
